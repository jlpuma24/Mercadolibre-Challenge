...
import com.melichallenge.databinding.FragmentPositiveOpinionsBinding
import com.melichallenge.domain.model.Review
import com.melichallenge.presentation.view.adapter.ProductReviewsAdapter

class PositiveOpinionsFragment: Fragment() {

    private lateinit var binding: FragmentPositiveOpinionsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPositiveOpinionsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    fun newInstance(reviewsList: ArrayList<Review>?) = PositiveOpinionsFragment().apply {
